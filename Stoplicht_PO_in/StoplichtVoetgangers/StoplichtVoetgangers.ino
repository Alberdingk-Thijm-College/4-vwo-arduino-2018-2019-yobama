...
void loop(){
  ...
  if(digitalRead(b1) == LOW){
    GL();    
    if(digitalRead(b2) == LOW|| digitalRead(b3) == LOW || digitalRead(b4) == LOW){
    delay(del);
      OL();
      delay(500);
      Clr();
  ...
  if(digitalRead(b2) == LOW){
    GB();
    if(digitalRead(b1) == LOW|| digitalRead(b3) == LOW || digitalRead(b4) == LOW){
      delay(del);
      OB();
      delay(500);
      Clr();
  ...
  if(digitalRead(b3) == LOW){
    GR();
    if(digitalRead(b1) == LOW|| digitalRead(b2) == LOW || digitalRead(b4) == LOW){
      delay(del);
    OR();
      delay(500);
      Clr();
